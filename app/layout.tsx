...
export const metadata: Metadata = {
  ...
  description: `${COMPANY.name} — licensed Bay Area general contractor serving 31 cities across 6 counties for 12+ years. Concrete foundations, structural repairs, remodels, decks, retaining walls & exterior repairs. 500+ projects completed. Free estimates. CA Lic #${COMPANY.license}.`,
  openGraph: {
    type: "website",
    locale: "en_US",
