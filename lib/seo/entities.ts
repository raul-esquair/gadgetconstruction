 ...
 *
 * The whole point is ONE authoritative entity graph: the business defines Raul
 * as its `founder` (full object, rendered on every page via localBusinessSchema),
 * and blog posts reference that same Raul by `@id` as their author. Google then
 * consolidates "Raul Arias, blog author" and "Raul Arias, owner of Gadget
...
export const OWNER_ID = `${COMPANY.url}/#raul`;
