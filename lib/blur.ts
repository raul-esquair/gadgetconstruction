 ...
 * Accepts `undefined` so callers can pass an optional field (a post's
 * `featuredImage`, say) without narrowing first.
 */
export function getBlurFor(src: string | undefined): string | undefined {
