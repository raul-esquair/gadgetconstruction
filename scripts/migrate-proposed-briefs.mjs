 ...
 * does NOT fire push-triggered workflows. Between 2026-05-15 and 2026-08-23 the
 * bot merged six proposal PRs and none of them ever migrated, so the queue ran
 * dry and weekly-draft.yml skipped silently for eight weeks. The auto-merge
 * workflow now runs this migration itself instead of relying on the push event.
 *
 * Behavior:
